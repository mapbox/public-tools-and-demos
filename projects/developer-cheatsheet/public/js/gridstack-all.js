    ...
    var e = {
        ...
        186: (e, t, i) => {
          ...
          class l extends n.DDBaseImplement {
            constructor(e, t = {}) {
              ...
              ;(this.dragEl = e.classList.contains(i)
                ? e
            ...
            enable() {
              !1 !== this.disabled &&
                ...
                r.isTouch &&
                  (this.dragEl.addEventListener('touchstart', r.touchstart),
                  this.dragEl.addEventListener('pointerdown', r.pointerdown)),
            ...
            disable(e = !1) {
              !0 !== this.disabled &&
                ...
                r.isTouch &&
                  (this.dragEl.removeEventListener('touchstart', r.touchstart),
            ...
            updateOption(e) {
              return (
                Object.keys(e).forEach((t) => (this.option[t] = e[t])), this
              )
            }
            _mouseDown(e) {
              ...
              return (
                ['input', 'textarea', 'button', 'select', 'option'].find(
                  (e) => e === t
                ) ||
                  ...
                  r.isTouch &&
                    (this.dragEl.addEventListener('touchmove', r.touchmove),
                    this.dragEl.addEventListener('touchend', r.touchend)),
                  e.preventDefault(),
            ...
            _mouseMove(e) {
              ...
              if (this.dragging)
                if ((this._dragFollow(e), s.DDManager.pauseDrag)) {
                  const t = Number.isInteger(s.DDManager.pauseDrag)
                ...
                let i =
                  null === (t = this.el.gridstackNode) || void 0 === t
                    ? void 0
                    : t.grid
                i
                  ? (s.DDManager.dropElement = i.el.ddElement.ddDroppable)
                  : delete s.DDManager.dropElement,
                ...
                this._setupHelperStyle(e),
                  this.option.start && this.option.start(n, this.ui()),
                  this.triggerEvent('dragstart', n)
              }
            ...
            _mouseUp(e) {
              ...
              if (
                ...
                r.isTouch &&
                  ...
                  this.dragEl.removeEventListener('touchend', r.touchend, !0)),
                this.dragging)
              ) {
                delete this.dragging,
                  (null === (t = s.DDManager.dropElement) || void 0 === t
                    ? void 0
                    : t.el) === this.el.parentElement &&
                    delete s.DDManager.dropElement,
                ...
                this.option.stop && this.option.stop(i),
                  ...
                  s.DDManager.dropElement && s.DDManager.dropElement.drop(e)
              }
              delete this.helper,
            ...
            _createHelper(e) {
              ...
              return (
                'function' == typeof this.option.helper
                  ...
                  : 'clone' === this.option.helper &&
                    (t = o.Utils.cloneNode(this.el)),
                ...
                t === this.el &&
                  (this.dragElementOriginStyle = l.originStyleProp.map(
                    (e) => this.el.style[e]
                  )),
                t
              )
            ...
            _dragFollow(e) {
              const t = this.helper.style,
                i = this.dragOffset
              ;(t.left = e.clientX + i.offsetLeft - 0 + 'px'),
                (t.top = e.clientY + i.offsetTop - 0 + 'px')
            }
              ...
              return (
                ...
                'fixed' !== this.helper.style.position &&
                  ((this.parentOriginStylePosition =
                    this.helperContainment.style.position),
                  window
                    .getComputedStyle(this.helperContainment)
            ...
            ui() {
              ...
              return {
                position: { top: t.top - e.top, left: t.left - e.left }
              }
            }
          }
          ;(t.DDDraggable = l),
          ...
          class l extends o.DDBaseImplement {
            ...
            enable() {
              !1 !== this.disabled &&
                ...
                r.isTouch &&
                  (this.el.addEventListener('pointerenter', r.pointerenter),
                  this.el.addEventListener('pointerleave', r.pointerleave)))
            }
            disable(e = !1) {
              !0 !== this.disabled &&
                (super.disable(),
                ...
                r.isTouch &&
                  (this.el.removeEventListener('pointerenter', r.pointerenter),
                  this.el.removeEventListener('pointerleave', r.pointerleave)))
            }
            destroy() {
              this.disable(!0),
                this.el.classList.remove('ui-droppable'),
            ...
            _mouseEnter(e) {
              ...
              e.preventDefault(),
                e.stopPropagation(),
                s.DDManager.dropElement &&
                  s.DDManager.dropElement !== this &&
                  s.DDManager.dropElement._mouseLeave(e),
                (s.DDManager.dropElement = this)
              ...
              this.option.over &&
                this.option.over(t, this._ui(s.DDManager.dragElement)),
            ...
            _mouseLeave(e) {
              ...
              if (
                (this.option.out &&
                  this.option.out(i, this._ui(s.DDManager.dragElement)),
            ...
            drop(e) {
              ...
              this.option.drop &&
                this.option.drop(t, this._ui(s.DDManager.dragElement)),
            ...
            _setupAccept() {
              return this.option.accept
                ? ('string' == typeof this.option.accept
                    ? (this.accept = (e) => e.matches(this.option.accept))
        ...
        320: (e, t, i) => {
          ...
          class r {
            ...
            on(e, t) {
              return (
                this.ddDraggable &&
                ['drag', 'dragstart', 'dragstop'].indexOf(e) > -1
            ...
            setupDraggable(e) {
              return (
                this.ddDraggable
                  ...
                  : (this.ddDraggable = new o.DDDraggable(this.el, e)),
                this
              )
            }
            cleanDraggable() {
            ...
            setupResizable(e) {
              return (
                this.ddResizable
                  ...
                  : (this.ddResizable = new s.DDResizable(this.el, e)),
                this
              )
            }
            cleanResizable() {
            ...
            setupDroppable(e) {
              return (
                this.ddDroppable
                  ...
                  : (this.ddDroppable = new n.DDDroppable(this.el, e)),
                this
              )
            }
            cleanDroppable() {
        ...
        958: (e, t, i) => {
          ...
          class a {
              ...
              return (
                this._getDDElements(e).forEach((e) => {
                  if ('disable' === t || 'enable' === t)
                    ...
                    let s = e.el.getAttribute('gs-resize-handles')
                        ? e.el.getAttribute('gs-resize-handles')
                        : i.opts.resizable.handles,
                      o = !i.opts.alwaysShowResizeHandle
                    e.setupResizable(
                      Object.assign(
                        Object.assign(Object.assign({}, i.opts.resizable), {
                          handles: s,
                          autoHide: o
                        }),
                        { start: t.start, stop: t.stop, resize: t.resize }
                      )
                    )
                  }
                }),
            ...
            dragIn(e, t) {
              return (
                this._getDDElements(e).forEach((e) => e.setupDraggable(t)), this
              )
            }
            droppable(e, t, i, s) {
              return (
            ...
            _getDDElements(e, t = !0) {
              ...
              if (!i.length) return []
              let s = i.map(
                (e) => e.ddElement || (t ? l.DDElement.init(e) : null)
              )
          ...
          ;(o.GridStack.prototype._setupAcceptWidget = function () {
            ...
            let e,
              ...
              i = (i, s, o) => {
                ...
                let l = this.el.getBoundingClientRect(),
                  { top: a, left: d } = o.getBoundingClientRect()
                ;(d -= l.left), (a -= l.top)
                let g = { position: { top: a, left: d } }
                if (r._temporaryRemoved) {
                  if (
                    ((r.x = Math.max(0, Math.round(d / t))),
                    ...
                    if (((r.autoPosition = !0), !this.engine.willItFit(r)))
                      return void h.off(s, 'drag')
                    r._willFitPos &&
                      (n.Utils.copyPos(r, r._willFitPos), delete r._willFitPos)
                  }
            ...
            return (
              h
                ...
                .on(this.el, 'dropover', (s, o, n) => {
                  ...
                  if (
                    (null == r ? void 0 : r.grid) === this &&
                    !r._temporaryRemoved
                  )
                    return !1
                  ;(null == r ? void 0 : r.grid) &&
                    r.grid !== this &&
                    !r._temporaryRemoved &&
                    r.grid._leave(o, n),
                    (t = this.cellWidth()),
                  ...
                  return (
                    r.grid && r.grid !== this
                      ...
                      : ((r.w = l), (r.h = a), (r._temporaryRemoved = !0)),
                    d(r.el, !1),
                    h.on(o, 'drag', i),
                    i(s, o, n),
                    !1
                ...
                .on(this.el, 'dropout', (e, t, i) => {
                  ...
                  return (
                    ...
                    ((s.grid && s.grid !== this) ||
                      (this._leave(t, i),
                      this._isTemp && this.removeAsSubGrid(s)),
                    !1)
                  )
                })
                .on(this.el, 'drop', (e, t, i) => {
                  ...
                  if ((null == r ? void 0 : r.grid) === this && !r._isExternal)
                    return !1
                  ...
                  if (
                    ...
                    l && (null == a ? void 0 : a.grid) && a.grid !== this)
                  ) {
                    let e = a.grid
                  ...
                  if (!r) return !1
                  if (
                    (l && (this.engine.cleanupNode(r), (r.grid = this)),
                    h.off(t, 'drag'),
                    i !== t
                      ? (i.remove(),
                        (t.gridstackNode = a),
                  ...
                  let d =
                    null ===
                      (o =
                        null === (s = r.subGrid) || void 0 === s
                          ? void 0
                          : s.el) || void 0 === o
                      ? void 0
                      : o.gridstack
                  return (
                    n.Utils.copyPos(r, this._readAttr(this.placeholder)),
                    n.Utils.removePositioningStyles(t),
                    this._writeAttr(t, r),
                    this.el.appendChild(t),
                    d &&
                      ((d.parentGridItem = r),
                      d.opts.styleInHead || d._updateStyles(!0)),
                    this._updateContainerHeight(),
                    this.engine.addedNodes.push(r),
                    ...
                    window.setTimeout(() => {
                      r.el && r.el.parentElement
                        ? this._prepareDragDropByNode(r)
                        : this.engine.removeNode(r),
                        delete r.grid._isTemp
                    }),
                    !1
                  )
                }),
            ...
            (o.GridStack.prototype._setupRemoveDrop = function () {
              if (
                !this.opts.staticGrid &&
                'string' == typeof this.opts.removable
              ) {
                ...
                h.isDroppable(e) ||
                  h
                    ...
                    .on(e, 'dropover', (e, t) => d(t, !0))
                    .on(e, 'dropout', (e, t) => d(t, !1))
              }
              return this
            }),
            (o.GridStack.setupDragIn = function (e, t) {
              void 0 !== (null == t ? void 0 : t.pause) &&
                (r.DDManager.pauseDrag = t.pause),
                'string' == typeof e &&
                  ((t = Object.assign(
                    Object.assign({}, s.dragInDefaultOptions),
                    t || {}
                  )),
                  n.Utils.getElements(e).forEach((e) => {
            ...
            (o.GridStack.prototype._prepareDragDropByNode = function (e) {
              ...
              if (!e._initDD) {
                let i,
                  s,
                  o = (o, n) => {
                    this._gsEventHandler[o.type] &&
                      this._gsEventHandler[o.type](o, o.target),
                      (i = this.cellWidth()),
                      (s = this.getCellHeight(!0)),
                      this._onStartMoving(t, o, n, e, i, s)
                  },
                  r = (o, n) => {
                  ...
                  l = (i) => {
                    ...
                    if (s.gridstackNode && s.gridstackNode.grid === this) {
                      if (((e.el = s), e._isAboutToRemove)) {
                        ...
                        o._gsEventHandler[i.type] &&
                          o._gsEventHandler[i.type](i, s),
                          this._removeDD(t),
                        ...
                        n.Utils.removePositioningStyles(s),
                          e._temporaryRemoved
                            ? (n.Utils.copyPos(e, e._orig),
                              this._writePosAttr(s, e),
                              this.engine.addNode(e))
                            : this._writePosAttr(s, e),
                          this._gsEventHandler[i.type] &&
                            this._gsEventHandler[i.type](i, s)
                ...
                h
                  .draggable(t, { start: o, stop: l, drag: r })
                  .resizable(t, { start: o, stop: l, resize: r }),
                  (e._initDD = !0)
              }
              return (
                h
                  .draggable(t, i ? 'disable' : 'enable')
                  .resizable(t, s ? 'disable' : 'enable'),
                this
              )
            }),
            (o.GridStack.prototype._onStartMoving = function (
              ...
              this.engine.cleanNodes().beginUpdate(s),
                ...
                'resizestart' === t.type &&
                  (h
                    .resizable(e, 'option', 'minWidth', o * (s.minW || 1))
                    .resizable(e, 'option', 'minHeight', n * (s.minH || 1)),
                  s.maxW && h.resizable(e, 'option', 'maxWidth', o * s.maxW),
                  s.maxH && h.resizable(e, 'option', 'maxHeight', n * s.maxH))
            }),
            ...
            (o.GridStack.prototype._dragOrResize = function (e, t, i, s, o, r) {
              ...
              if (
                ...
                ;(s._prevYPix = i.position.top),
                  n.Utils.updateScrollPosition(e, i.position, t)
                let l =
                    i.position.left +
                    (i.position.left > s._lastUiPosition.left ? -d : h),
                  u =
                    i.position.top +
                    (i.position.top > s._lastUiPosition.top ? -p : g)
                ...
                if (
                  (this._extraDragRow !== c && this._updateContainerHeight(),
                  s.x === a.x && s.y === a.y)
                )
                  return
                ...
                if (a.x < 0) return
                if (
                  (n.Utils.updateScrollResize(t, e, r),
                  (a.w = Math.round((i.size.width - h) / o)),
                  (a.h = Math.round((i.size.height - g) / r)),
                  s.w === a.w && s.h === a.h)
                )
                  return
                if (
              ...
              if (
                ...
                ;(s._lastUiPosition = i.position),
                  this.engine.cacheRects(o, r, g, d, p, h),
                  delete s._skipDown,
                  l && s.subGrid && s.subGrid.onParentResize(),
                  (this._extraDragRow = 0),
                  this._updateContainerHeight()
                let e = t.target
                this._writePosAttr(e, s),
                  this._gsEventHandler[t.type] &&
                    this._gsEventHandler[t.type](t, e)
              }
            }),
            (o.GridStack.prototype.movable = function (e, t) {
              return (
                this.opts.staticGrid ||
                  o.GridStack.getElements(e).forEach((e) => {
                    let i = e.gridstackNode
                    i &&
            ...
            (o.GridStack.prototype._removeDD = function (e) {
              return (
                h.draggable(e, 'destroy').resizable(e, 'destroy'),
          ...
          class o {
            ...
            _init() {
              ...
              return (
                ...
                s.isTouch &&
                  (this.el.addEventListener('touchstart', s.touchstart),
                  this.el.addEventListener('pointerdown', s.pointerdown)),
                this
              )
            }
            destroy() {
              return (
                ...
                s.isTouch &&
                  (this.el.removeEventListener('touchstart', s.touchstart),
                  this.el.removeEventListener('pointerdown', s.pointerdown)),
            ...
            _mouseDown(e) {
              ;(this.mouseDownEvent = e),
                ...
                document.addEventListener('mouseup', this._mouseUp, !0),
                s.isTouch &&
                  (this.el.addEventListener('touchmove', s.touchmove),
                  this.el.addEventListener('touchend', s.touchend)),
                e.stopPropagation(),
                e.preventDefault()
            }
            _mouseMove(e) {
            ...
            _mouseUp(e) {
              this.moving && this._triggerEvent('stop', e),
                ...
                document.removeEventListener('mouseup', this._mouseUp, !0),
                s.isTouch &&
                  (this.el.removeEventListener('touchmove', s.touchmove),
                  this.el.removeEventListener('touchend', s.touchend)),
                delete this.moving,
                delete this.mouseDownEvent,
                e.stopPropagation(),
                e.preventDefault()
        ...
        204: (e, t, i) => {
          ...
          class l extends o.DDBaseImplement {
            constructor(e, t = {}) {
              super(),
                (this._ui = () => {
                  ...
                  return {
                    position: { left: i.left - e.left, top: i.top - e.top },
              ...
              return (
                e
                  ...
                  : (this.el.classList.remove('ui-resizable-autohide'),
                    ...
                    r.DDManager.overResizeElement === this &&
                      delete r.DDManager.overResizeElement),
                this
              )
            }
            _mouseOver(e) {
              r.DDManager.overResizeElement ||
                r.DDManager.dragElement ||
                ((r.DDManager.overResizeElement = this),
                this.el.classList.remove('ui-resizable-autohide'))
            }
            ...
            _getChange(e, t) {
              ...
              t.indexOf('e') > -1
                ? (s.width += o)
                : t.indexOf('w') > -1 && ((s.width -= o), (s.left += o)),
                t.indexOf('s') > -1
                  ? (s.height += n)
                  : t.indexOf('n') > -1 && ((s.height -= n), (s.top += n))
              const r = this._constrainSize(s.width, s.height)
              return (
                Math.round(s.width) !== Math.round(r.width) &&
                  (t.indexOf('w') > -1 && (s.left += s.width - r.width),
                  (s.width = r.width)),
                Math.round(s.height) !== Math.round(r.height) &&
                  (t.indexOf('n') > -1 && (s.top += s.height - r.height),
                  (s.height = r.height)),
                s
              )
            }
        ...
        635: (e, t, i) => {
          ...
          ;(t.touchstart = function (e) {
            ...
            (t.touchend = function (e) {
              ...
              o.pointerLeaveTimeout &&
                (window.clearTimeout(o.pointerLeaveTimeout),
                delete o.pointerLeaveTimeout)
        ...
        62: (e, t, i) => {
          ...
          class o {
            ...
            _fixCollisions(e, t = e, i, o = {}) {
              if ((this.sortNodes(-1), !(i = i || this.collide(e, t))))
                return !1
              if (e._moving && !o.nested && !this.float && this.swap(e, i))
                return !0
              let n = t
            ...
            collide(e, t = e, i) {
              return this.nodes.find(
                (o) => o !== e && o !== i && s.Utils.isIntercepted(o, t)
              )
            }
            collideAll(e, t = e, i) {
              ...
              return (
                ...
                i.forEach((e) => {
                  ...
                  o.y < t.y
                    ...
                    o.x < t.x
                      ? (r = (n.x + n.w - t.x) / t.w)
                      : o.x + o.w > t.x + t.w && (r = (t.x + t.w - n.x) / t.w)
                  let a = Math.min(r, i)
                  a > l && ((l = a), (s = e))
                }),
                (t.collide = s),
            ...
            sortNodes(e) {
              return (
                (this.nodes = s.Utils.sort(this.nodes, e, this.column)), this
              )
            }
            _packNodes() {
              return (
            ...
            nodeBoundFix(e, t) {
              ...
              if (
                ...
                e.minW &&
                  e.minW <= this.column &&
                  (e.w = Math.max(e.w, e.minW)),
                e.minH && (e.h = Math.max(e.h, e.minH)),
                (1 === this.column || e.x + e.w > this.column) &&
                  this.column < 12 &&
            ...
            getDirtyNodes(e) {
              return e
                ? this.nodes.filter(
                    (e) => e._dirty && !s.Utils.samePos(e, e._orig)
                  )
            ...
            restoreInitial() {
              return (
                this.nodes.forEach((e) => {
                  s.Utils.samePos(e, e._orig) ||
                    (s.Utils.copyPos(e, e._orig), (e._dirty = !0))
                }),
                this._notify(),
                this
              )
            ...
            findEmptyPosition(e) {
              ...
              for (let i = 0; !t; ++i) {
                ...
                let r = { x: o, y: n, w: e.w, h: e.h }
                this.nodes.find((e) => s.Utils.isIntercepted(r, e)) ||
                  ((e.x = o), (e.y = n), (t = !0))
              }
              return t
            }
            ...
            willItFit(e) {
              ...
              return (
                ...
                t.getRow() <= this.maxRow &&
                  ((e._willFitPos = s.Utils.copyPos({}, i)), !0)
              )
            }
            ...
            moveNode(e, t) {
              ...
              if (h.length) {
                ...
                if (
                  ...
                  i / (o < n ? o : n) > 0.8 &&
                    (a.grid.makeSubGrid(a.el, void 0, e), (a = void 0))
                }
                a
                  ? (d = !this._fixCollisions(e, l, a, t))
                  : ((d = !1), n && delete t.pack)
              }
              return (
                d && ((e._dirty = !0), s.Utils.copyPos(e, l)),
              ...
              return (
                ...
                this.nodes.forEach((t) => {
                  ...
                  i && ((r.x = i.x), (r.y = i.y), (r.w = i.w)),
                    s.Utils.removeInternalForSave(r, !e),
                    n.push(r)
                }),
                n
              )
            ...
            updateNodeWidths(e, t, i, o = 'moveScale') {
              ...
              if (t > e) {
                ...
                !a.length &&
                  e !== s &&
                  (null === (n = this._layouts[s]) || void 0 === n
                    ? void 0
                    : n.length) &&
                  ((e = s),
            ...
            cacheOneLayout(e, t) {
              ...
              return (
                -1 === s ? this._layouts[t].push(i) : (this._layouts[t][s] = i),
                this
              )
            }
            findCacheLayout(e, t) {
              ...
              return null !==
                (o =
                  null ===
                    (s =
                      null === (i = this._layouts) || void 0 === i
                        ? void 0
                        : i[t]) || void 0 === s
                    ? void 0
                    : s.findIndex((t) => t._id === e._id)) && void 0 !== o
                ? o
                : -1
            }
            cleanupNode(e) {
        ...
        270: function (e, t, i) {
          var s =
            ...
            o =
              ...
              function (e, t) {
                for (var i in e)
                  'default' === i || t.hasOwnProperty(i) || s(t, e, i)
              }
          Object.defineProperty(t, '__esModule', { value: !0 }),
            (t.GridStack = void 0)
          const n = i(62),
          ...
          class a {
            constructor(e, t = {}) {
              ...
              ;(this._gsEventHandler = {}),
                ...
                (this.el = e),
                (t = t || {}).row &&
                  ((t.minRow = t.maxRow = t.row), delete t.row)
              let o = r.Utils.toNumber(e.getAttribute('gs-row'))
              'auto' === t.column && delete t.column
              let g = t
              void 0 !== g.minWidth &&
                ((t.oneColumnSize = t.oneColumnSize || g.minWidth),
                delete g.minWidth),
                void 0 !== t.alwaysShowResizeHandle &&
                  (t._alwaysShowResizeHandle = t.alwaysShowResizeHandle)
              let p = Object.assign(
                Object.assign({}, r.Utils.cloneDeep(l.gridDefaults)),
                {
                  column:
                    r.Utils.toNumber(e.getAttribute('gs-column')) ||
                    l.gridDefaults.column,
                  minRow:
                    o ||
                    r.Utils.toNumber(e.getAttribute('gs-min-row')) ||
                    l.gridDefaults.minRow,
                  maxRow:
                    o ||
                    r.Utils.toNumber(e.getAttribute('gs-max-row')) ||
                    l.gridDefaults.maxRow,
                  staticGrid:
                    r.Utils.toBool(e.getAttribute('gs-static')) ||
                    l.gridDefaults.staticGrid,
                  draggable: {
                    handle:
                      (t.handleClass
                        ? '.' + t.handleClass
                        : t.handle
                        ? t.handle
                        : '') || l.gridDefaults.draggable.handle
                  },
                  removableOptions: {
                    accept: t.itemClass
                      ? '.' + t.itemClass
                      : l.gridDefaults.removableOptions.accept
                  }
                }
              )
              e.getAttribute('gs-animate') &&
                (p.animate = r.Utils.toBool(e.getAttribute('gs-animate'))),
                (this.opts = r.Utils.defaults(t, p)),
                (t = null),
                this._initMargin(),
                1 !== this.opts.column &&
                  !this.opts.disableOneColumnMode &&
                  this._widthOrContainer() <= this.opts.oneColumnSize &&
              ...
              let u =
                null ===
                  (i = r.Utils.closestUpByClass(
                    this.el,
                    l.gridDefaults.itemClass
                  )) || void 0 === i
                  ? void 0
                  : i.gridstackNode
              u &&
                ((u.subGrid = this),
                (this.parentGridItem = u),
                this.el.classList.add('grid-stack-nested'),
                u.el.classList.add('grid-stack-sub-grid')),
                ...
                this._isAutoCellHeight || 'initial' === this.opts.cellHeight
                  ...
                  : ('number' == typeof this.opts.cellHeight &&
                      ...
                      this.opts.cellHeightUnit !==
                        l.gridDefaults.cellHeightUnit &&
                      ((this.opts.cellHeight =
                        this.opts.cellHeight + this.opts.cellHeightUnit),
                      delete this.opts.cellHeightUnit),
                    this.cellHeight(this.opts.cellHeight, !1)),
                'mobile' === this.opts.alwaysShowResizeHandle &&
                  (this.opts.alwaysShowResizeHandle = h.isTouch),
                (this._styleSheetClass =
                  'grid-stack-instance-' + n.GridStackEngine._idSeq++),
                this.el.classList.add(this._styleSheetClass),
                this._setStaticClass()
              let c =
                this.opts.engineClass || a.engineClass || n.GridStackEngine
              if (
                ((this.engine = new c({
                ...
                let e = [],
                  t = this.getColumn()
                1 === t && this._prevColumn && (t = this._prevColumn),
                  this.getGridItems().forEach((i) => {
              ...
              this.setAnimation(this.opts.animate),
                ...
                this.opts.dragIn &&
                  a.setupDragIn(this.opts.dragIn, this.opts.dragInOptions),
                delete this.opts.dragIn,
                delete this.opts.dragInOptions,
                this.opts.subGridDynamic &&
                  !d.DDManager.pauseDrag &&
                  (d.DDManager.pauseDrag = !0),
                void 0 !==
                  (null === (s = this.opts.draggable) || void 0 === s
                    ? void 0
                    : s.pause) &&
                  (d.DDManager.pauseDrag = this.opts.draggable.pause),
            ...
            static init(e = {}, t = '.grid-stack') {
              ...
              return i
                ? (i.gridstack ||
                    (i.gridstack = new a(i, r.Utils.cloneDeep(e))),
                  i.gridstack)
                : ('string' == typeof t
                    ? console.error(
            ...
            static initAll(e = {}, t = '.grid-stack') {
              ...
              return (
                a.getGridElements(t).forEach((t) => {
                  t.gridstack ||
                    ((t.gridstack = new a(t, r.Utils.cloneDeep(e))),
                    delete e.dragIn,
            ...
            addWidget(e, t) {
              ...
              return (
                ...
                this._updateContainerHeight(),
                n.subGrid && this.makeSubGrid(n.el, void 0, void 0, !1),
                this._prevColumn &&
                  1 === this.opts.column &&
            ...
            makeSubGrid(e, t, i, s = !0) {
              ...
              let n,
                l = e.gridstackNode
              if (
                (l || (l = this.makeWidget(e).gridstackNode),
                null === (o = l.subGrid) || void 0 === o ? void 0 : o.el)
              )
                return l.subGrid
              ;((t = r.Utils.cloneDeep(
                t ||
                  l.subGrid ||
                  Object.assign(Object.assign({}, this.opts.subGrid), {
                    children: void 0
                  })
              )).subGrid = r.Utils.cloneDeep(t)),
                (l.subGrid = t),
                'auto' === t.column &&
                  ((n = !0),
                  (t.column = Math.max(
                  ...
                  (t.disableOneColumnMode = !0))
              let h,
                d,
                g = l.el.querySelector('.grid-stack-item-content')
              if (s) {
                this._removeDD(l.el)
                ...
                ;(e.body.innerHTML = '<div class="grid-stack-item"></div>'),
                  (h = e.body.children[0]),
                  h.appendChild(g),
                  (d = Object.assign(Object.assign({}, l), { x: 0, y: 0 })),
                  r.Utils.removeInternalForSave(d),
                  delete d.subGrid,
                  l.content && ((d.content = l.content), delete l.content),
                  (e.body.innerHTML =
                    '<div class="grid-stack-item-content"></div>'),
                  (g = e.body.children[0]),
                  l.el.appendChild(g),
                  this._prepareDragDropByNode(l)
              }
              if (i) {
                let e = n ? t.column : l.w,
                  ...
                  o = l.el.style
                ;(o.transition = 'none'),
                  this.update(l.el, { w: e, h: s }),
                  setTimeout(() => (o.transition = null))
              }
              let p = (l.subGrid = a.addGrid(g, t))
              return (
                (null == i ? void 0 : i._moving) && (p._isTemp = !0),
                n && (p._autoColumn = !0),
                s && p.addWidget(h, d),
                i &&
                  (i._moving
            ...
            removeAsSubGrid(e) {
              var t
              let i =
                null === (t = this.parentGridItem) || void 0 === t
                  ? void 0
                  : t.grid
              i &&
                (i.batchUpdate(),
                i.removeWidget(this.parentGridItem.el, !0, !0),
                this.engine.nodes.forEach((e) => {
                ...
                e &&
                  window.setTimeout(
                    () =>
                      r.Utils.simulateMouseEvent(e._event, 'mouseenter', i.el),
                    0
                  ))
            }
            save(e = !0, t = !1) {
              ...
              if (
                ...
                e.marginBottom === e.marginTop &&
                  ...
                  delete e.marginLeft),
                  e.rtl === ('rtl' === this.el.style.direction) &&
                    (e.rtl = 'auto'),
                ...
                return (
                  ...
                  r.Utils.removeInternalAndSame(e, l.gridDefaults),
                  (e.children = i),
                  e
                )
              }
                ...
                t &&
                  [...this.engine.nodes].forEach((e) => {
                    i.find((t) => e.id === t.id) ||
                      ('function' == typeof t
                        ? t(this, e, !1)
                        : (s.push(e), this.removeWidget(e.el, !0, !1)))
                  }),
                i.forEach((e) => {
                  let i =
                    e.id || 0 === e.id
                  ...
                  if (i) {
                    if (
                      (this.update(i.el, e), e.subGrid && e.subGrid.children)
                    ) {
              ...
              return (
                a.getElements(e).forEach((e) => {
                  ...
                  if (
                    ...
                    t && t.innerHTML !== s.content && (t.innerHTML = s.content),
                      delete s.content
                  }
                  let l = !1,
                    a = !1
            ...
            _removeStylesheet() {
              return (
                this._styles &&
                  (r.Utils.removeStylesheet(this._styleSheetClass),
                  delete this._styles),
                this
              )
            }
            _updateStyles(e = !1, t) {
              ...
              if (!this._styles) {
                ...
                if (
                  ((this._styles = r.Utils.createStylesheet(
                    this._styleSheetClass,
                    e
                  )),
                  !this._styles)
            ...
            _updateContainerHeight() {
              ...
              if ((this.el.setAttribute('gs-current-row', String(e)), 0 === e))
                return this.el.style.removeProperty('min-height'), this
            ...
            _prepareElement(e, t = !1, i) {
              i ||
                (e.classList.add(this.opts.itemClass), (i = this._readAttr(e))),
                (e.gridstackNode = i),
                (i.el = e),
                (i.grid = this)
              ...
              return (
                ...
                r.Utils.same(i, s) || this._writeAttr(e, i),
                this._prepareDragDropByNode(i),
                this
              )
            }
            ...
            _writeAttr(e, t) {
              ...
              for (const s in i)
                t[s]
                  ? e.setAttribute(i[s], String(t[s]))
                  : e.removeAttribute(i[s])
              return this
            }
            _readAttr(e) {
              let t = {}
            ...
            onParentResize() {
              ...
              if (this._autoColumn && this.parentGridItem)
                this.opts.column !== this.parentGridItem.w &&
                  ((e = !0), this.column(this.parentGridItem.w, 'none'))
              else {
                let t =
                  !this.opts.disableOneColumnMode &&
                  this.el.clientWidth <= this.opts.oneColumnSize
        ...
        699: (e, t) => {
          Object.defineProperty(t, '__esModule', { value: !0 }),
            (t.dragInDefaultOptions = t.gridDefaults = void 0),
            (t.gridDefaults = {
        ...
        593: (e, t) => {
          Object.defineProperty(t, '__esModule', { value: !0 }),
            ...
            (t.obsoleteOptsDel = function (e, t, i, s) {
              void 0 !== e[t] &&
                console.warn(
                  'gridstack.js: Option `' + t + '` is deprecated in ' + i + s
                )
            }),
            ...
            static createStylesheet(e, t) {
              ...
              return (
                ...
                t
                  ...
                  : (t = document.getElementsByTagName('head')[0]).appendChild(
                      i
                    ),
                i.sheet
              )
